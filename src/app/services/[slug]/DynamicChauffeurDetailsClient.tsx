    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      {features.map((feature, index) => {
        ...
        return (
          ...
          >
            <div className="w-12 h-12 rounded-lg bg-luxury-gold/5 flex items-center justify-center text-[#D0A511] mb-6 border border-luxury-gold/10 group-hover:scale-105 transition-transform duration-300">
              <Icon className="w-5 h-5" />
            </div>
            <h3 className="text-lg font-serif text-white mb-3 group-hover:text-[#D0A511] transition-colors duration-300">
              {feature.title}
            </h3>
