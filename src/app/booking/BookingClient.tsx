          ...
          >
            ...
            <div className="glass-panel p-6 rounded-lg w-full max-w-md border border-luxury-gold/15 text-left flex flex-col gap-4 text-xs md:text-sm mb-8">
              <div className="flex justify-between border-b border-luxury-gold/10 pb-3">
                ...
                <span className="text-luxury-gold font-semibold tracking-widest uppercase">
                  {bookingRef || `AR-${Math.floor(100000 + Math.random() * 900000)}`}
                </span>
              </div>
              ...
              <div className="flex justify-between">
                ...
                <span className="text-white font-medium">
                  {bookingDetails.dateTime ? new Date(bookingDetails.dateTime).toLocaleString() : "Confirmed on itinerary"}
                </span>
              </div>
            </div>
