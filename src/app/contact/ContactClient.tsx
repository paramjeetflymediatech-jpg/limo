        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                { icon: Phone, title: "Phone", details: "+1 (778) 688‑0333", href: "tel:+17786880333" },
                { icon: Mail, title: "Email", details: "info@fantasticlimo.ca", href: "mailto: info@fantasticlimo.ca" },
                { icon: MapPin, title: "Address", details: "Vancouver, BC, Canada", href: "#" },
            ...
            <div className="relative rounded-lg overflow-hidden border border-luxury-gold/20 shadow-[0_0_30px_rgba(208,165,17,0.08)]" style={{ height: "320px" }}>
              ...
              <iframe src="https://maps.google.com/maps?q=Vancouver,%20BC,%20Canada&t=&z=11&ie=UTF8&iwloc=&output=embed"
