...
`;
    const adminMailHtml = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #d4af37; background-color: #0a0a0a; color: #ffffff;">
        <h2 style="color: #d4af37; border-bottom: 2px solid #d4af37; padding-bottom: 10px; margin-top: 0;">New Concierge Inquiry</h2>
        <p>A user has sent an inquiry via the online contact desk.</p>
        <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
          <tr style="background-color: #111111;"><td style="padding: 10px; font-weight: bold; width: 120px;">Name:</td><td style="padding: 10px;">${name}</td></tr>
          <tr><td style="padding: 10px; font-weight: bold;">Email:</td><td style="padding: 10px;"><a href="mailto:${email}" style="color: #d4af37;">${email}</a></td></tr>
          <tr style="background-color: #111111;"><td style="padding: 10px; font-weight: bold;">Phone:</td><td style="padding: 10px;"><a href="tel:${phone}" style="color: #d4af37;">${phone}</a></td></tr>
          <tr><td style="padding: 10px; font-weight: bold;">Subject:</td><td style="padding: 10px; color: #f5d06f; font-weight: bold;">${subject}</td></tr>
        </table>
        <h4 style="color: #d4af37; margin-bottom: 5px;">Message Content:</h4>
        <div style="background-color: #111111; padding: 15px; border-radius: 4px; border: 1px solid #222; white-space: pre-wrap; font-size: 13px; line-height: 1.5;">${message}</div>
...
`;
    const customerMailHtml = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 25px; border: 1px solid #d4af37; background-color: #0a0a0a; color: #ffffff;">
        ...
        <div style="background-color: #111111; padding: 15px; border: 1px solid #222; margin: 20px 0; font-size: 13px;">
          <h4 style="color: #d4af37; margin-top: 0; margin-bottom: 10px; text-transform: uppercase;">Message Copy</h4>
