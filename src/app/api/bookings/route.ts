...
`;
      const adminHtml = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #d4af37; background-color: #0a0a0a; color: #ffffff;">
          <h2 style="color: #d4af37; border-bottom: 2px solid #d4af37; padding-bottom: 10px; margin-top: 0;">New Booking Dispatch Notification</h2>
          <p>A new chauffeur booking request has been registered in the reservation desk.</p>
          <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
            <tr style="background-color: #111111;"><td style="padding: 10px; font-weight: bold; width: 150px; border-bottom: 1px solid #222;">Reference ID:</td><td style="padding: 10px; border-bottom: 1px solid #222; color: #d4af37; font-weight: bold;">${newId}</td></tr>
            ...
            <tr style="background-color: #111111;"><td style="padding: 10px; font-weight: bold; border-bottom: 1px solid #222;">Email:</td><td style="padding: 10px; border-bottom: 1px solid #222;"><a href="mailto:${email}" style="color: #d4af37;">${email || "Not Provided"}</a></td></tr>
            <tr><td style="padding: 10px; font-weight: bold; border-bottom: 1px solid #222;">Phone:</td><td style="padding: 10px; border-bottom: 1px solid #222;"><a href="tel:${phone}" style="color: #d4af37;">${phone || "Not Provided"}</a></td></tr>
            <tr style="background-color: #111111;"><td style="padding: 10px; font-weight: bold; border-bottom: 1px solid #222;">Vehicle:</td><td style="padding: 10px; border-bottom: 1px solid #222;">${vehicle}</td></tr>
            ...
            <tr style="background-color: #111111;"><td style="padding: 10px; font-weight: bold; border-bottom: 1px solid #222;">Pickup:</td><td style="padding: 10px; border-bottom: 1px solid #222;">${pickup}</td></tr>
            ...
            <tr style="background-color: #111111;"><td style="padding: 10px; font-weight: bold; border-bottom: 1px solid #222;">Passengers:</td><td style="padding: 10px; border-bottom: 1px solid #222;">${passengers || "1"} Guests</td></tr>
            <tr><td style="padding: 10px; font-weight: bold; border-bottom: 1px solid #222;">Status:</td><td style="padding: 10px; border-bottom: 1px solid #222; color: #f5d06f; font-weight: bold;">Pending</td></tr>
          </table>
...
FantasticLimo Chauffeur Services
        ...
        const customerHtml = `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 25px; border: 1px solid #d4af37; background-color: #0a0a0a; color: #ffffff;">
            ...
            <div style="background-color: #111111; padding: 15px; border-left: 3px solid #d4af37; margin: 20px 0;">
              <h4 style="color: #d4af37; margin-top: 0; margin-bottom: 10px; font-size: 14px; text-transform: uppercase; letter-spacing: 1px;">Reservation Request Details</h4>
              <p style="margin: 5px 0; font-size: 13px;"><strong>Reference ID:</strong> <span style="color: #f5d06f; font-weight: bold;">${newId}</span></p>
              ...
              <p style="margin: 5px 0; font-size: 13px;"><strong>Status:</strong> <span style="color: #f5d06f; font-weight: bold;">Pending Dispatcher Review</span></p>
            </div>
