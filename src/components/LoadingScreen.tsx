        ...
        >
          ...
          <div className="relative flex flex-col items-center justify-center w-full max-w-sm px-8">
            ...
            <div className="w-full flex flex-col items-center gap-4">
              {/* Progress Text */}
              <div className="flex justify-between w-full text-[10px] font-bold text-luxury-gold uppercase tracking-[0.25em]">
                <span>Loading</span>
              ...
              <div className="w-full h-[1px] bg-white/10 overflow-hidden relative rounded-full">
                {/* Progress Bar Fill */}
                <motion.div 
                  className="absolute top-0 left-0 h-full bg-luxury-gold shadow-[0_0_15px_rgba(208,165,17,0.8)]"
